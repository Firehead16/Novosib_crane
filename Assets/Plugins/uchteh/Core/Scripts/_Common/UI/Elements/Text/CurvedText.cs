...
namespace Core.Ui
{
    ...
    {
        [SerializeField]
        private AnimationCurve curveForText = AnimationCurve.Linear(0, 0, 1, 10);

        public AnimationCurve CurveForText
        {
            get => curveForText;
            set { curveForText = value; graphic.SetVerticesDirty(); }
        }

        [SerializeField]
        private float curveMultiplier = 1;

        public float CurveMultiplier
        {
            get => curveMultiplier;
            set { curveMultiplier = value; graphic.SetVerticesDirty(); }
        }
