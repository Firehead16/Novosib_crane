...
namespace Core.Ui.Extensions
{
    ...
    public class Gradient2 : BaseMeshEffect
    {
        ...
        [SerializeField]
        UnityEngine.Gradient effectGradient = new UnityEngine.Gradient() { colorKeys = new GradientColorKey[] { new GradientColorKey(Color.black, 0), new GradientColorKey(Color.white, 1) } };
                ...
                case Type.Vertical:
                    {
                        ...
                        if (ModifyVertices)
                        {
                            SplitTrianglesAtGradientStops(vertexList, bounds, zoomOffset, helper);
                        }
                ...
                case Type.Diamond:
                    {
                        ...
                        {
                            helper.Clear();
                            for (int i = 0; i < nCount; i++) helper.AddVert(vertexList[i]);
