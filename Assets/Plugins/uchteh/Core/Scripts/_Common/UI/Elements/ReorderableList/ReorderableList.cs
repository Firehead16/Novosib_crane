...
namespace Core.Ui.Extensions
{
    ...
    public class ReorderableList : MonoBehaviour
    {
        ...
        // Устанавливает размер каждого элемента (при перетаскивании по этому списку) равным текущему размеру первого элемента этого списка
        ...
        {
	        Destroy(listContent);
	        listContent = ContentLayout.gameObject.AddComponent<ReorderableListContent>();
	        listContent.Init(this);
        }
